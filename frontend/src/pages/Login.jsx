...
export default function Login() {
  const { loginEmail, loginWithGoogle, loginWithGithub } = useAuth();
      ...
      <div className="max-w-md w-full vercel-card p-8 sm:p-10 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="vercel-btn-primary w-full py-2.5 text-sm flex items-center justify-center gap-1 cursor-pointer disabled:opacity-50"
          >
            {loading ? (
